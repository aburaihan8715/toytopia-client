        ...
        <section className="mb-32 text-gray-800 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
            <div className="mb-12 md:mb-0">
              ...
              <h6 className="font-medium text-secondary mb-4">Teacher</h6>
              <p className="mb-4">
                <svg
                  aria-hidden="true"
                  focusable="false"
            ...
            <div className="mb-12 md:mb-0">
              ...
              <h6 className="font-medium text-secondary mb-4">Housewife</h6>
              <p className="mb-4">
                <svg
                  aria-hidden="true"
                  focusable="false"
            ...
            <div className="mb-0">
              ...
              <h6 className="font-medium text-secondary  mb-4">Business man</h6>
              <p className="mb-4">
                <svg
                  aria-hidden="true"
                  focusable="false"
